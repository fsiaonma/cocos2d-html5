var About = cc.Layer.extend({
  ...
  loadBg: function() {
    ...
    this.addPic(P_MENUBG, cc.p(0.5, 0.5), cc.p(WIN_SIZE.width / 2, WIN_SIZE.height / 2), 1, -1);
    this.addPic(P_ABOUT_PAGE, cc.p(0.5, 0.5), cc.p(WIN_SIZE.width / 2, WIN_SIZE.height / 2), 1, 10);
  ...
  loadLabel: function() {
    ...
    this.menu.setPosition(cc.p(WIN_SIZE.width / 2, WIN_SIZE.height / 7));
