...
var Property = cc.Layer.extend({
  ...
  ctor: function(route, type) {
    ...
    this.propertyBgSprite.setVisible(false);
  ...
  activate: function() {
    ...
    this.propertySprite.setVisible(false);
    this.propertyBgSprite.setPosition(cc.p(0, 2 * CHARACTER.SPRITE_HEIGHT));
    this.propertyBgSprite.setVisible(true);
