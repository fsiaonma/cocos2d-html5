...
var Character = cc.Layer.extend({
  ...
  ctor: function() {
    ...
    this.hpDecreaseBg.setVisible(false);
    ...
    this.setPosition(cc.p(WIN_SIZE.width / 2, WIN_SIZE.height / 4));
  ...
  setSrc: function(index) {
    ...
    var characterTexture = cc.TextureCache.getInstance().addImage(this.sources[index]);
  ...
  hpDecrease: function() {
    ...
    this.hpDecreaseBg.setPosition(cc.p(0, CHARACTER.SPRITE_HEIGHT / 2));
    this.hpDecreaseBg.setVisible(true);
    // this.hpDecreaseBg.runAction(cc.ScaleTo.create(0.5, 2));
    // this.hpDecreaseBg.runAction(cc.FadeOut.create(1));

    this.hpDecreaseBg.runAction(cc.Sequence.create(
  ...
  moveLeft: function() {
    ...
    this.moveLeftAction = cc.MoveTo.create(
      ...
      cc.p(this.currentRoute * ROUTE.WIDTH + TRACK.LEFT_COORDINATE, WIN_SIZE.height / 4)
    );
  ...
  moveLeftMost: function() {
    ...
    this.moveLeftAction = cc.MoveTo.create(
      ...
      cc.p(ROUTE.LEFT * ROUTE.WIDTH + TRACK.LEFT_COORDINATE, WIN_SIZE.height / 4)
    );
  ...
  moveRightMost: function() {
    ...
    this.moveRightAction = cc.MoveTo.create(
      ROUTE.WIDTH * 3 / CHARACTER.MOVE_VELOCITY, 
      cc.p(ROUTE.RIGHT * ROUTE.WIDTH + TRACK.LEFT_COORDINATE, WIN_SIZE.height / 4)
    );
    this.runAction(this.moveRightAction);
